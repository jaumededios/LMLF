...
relation and finite-exceptional continuous-primitive layer.  Its revision-1
draft card and complete author proof bind six prospective targets, but its name
and boundary still require registry reconciliation, exact signatures,
independent reviews, and authorization before Lean.
...
| Watson source pilot | provisional `IMP-001`; registered `QL-001`, `OLV-001`, `SR-001` | IMP-001 has an unregistered revision-1 draft card/complete author proof; QL-001 and OLV-001 have revision-2 draft cards and complete draft proofs; all remain unreviewed, and SR-001 is not yet carded |
...
- Independent Watson collation review, the pinned-Mathlib reuse audit,
  IMP-001 revision-1 card/proof review, and review of the revision-2 generic finite
...
unregistered IMP-001 revision-1 draft must receive exact signatures, independent
reviews, registry reconciliation, and authorization before Lean.  The occurrence-card association uses
