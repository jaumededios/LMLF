...
The 93 imported files are byte-for-byte copies of the source archive. The allowlist was limited to Markdown, JSON, YAML, and YML files. `SHA256SUMS` records the imported-file hashes; it intentionally excludes this README and itself.
...
Source PDFs, OCR output, page images, credentials, and caches were not imported.
